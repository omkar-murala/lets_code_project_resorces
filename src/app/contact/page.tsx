      ...
      <div className="bg-slate-700 shadow-lg rounded-lg overflow-hidden flex flex-col md:flex-row w-full max-w-5xl">
        ...
        <div className="p-8 md:w-1/2">
          <form>
            ...
            <div className="mb-4">
              <label htmlFor="username" className="block text-white font-medium mb-2">Explore username</label>
            ...
            <div className="mb-4">
              ...
              <textarea id="message" name="message" rows={4} className="w-full px-4 py-2 border border-gray-300 rounded-md" placeholder='Your message...'></textarea>
            </div>
