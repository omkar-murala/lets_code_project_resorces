    ...
    <div className="w-full px-4 py-3 bg-slate-800 sm:px-6 md:px-12 lg:px-20 xl:px-32 2xl:px-40">
      <div className="bg-white shadow-lg rounded-lg p-6">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li className="mb-2">
            <strong>Company</strong> (referred to as either the Company, We, Us or Our in this Agreement) refers to Let&apos;s Code, New Delhi.
          </li>
          <li className="mb-2">
          ...
          <li className="mb-2">
            <strong>Website</strong> refers to Let&apos;s Resource, accessible from <a href="https://letsresource.in/" target="_blank" rel="noopener noreferrer" className="text-blue-500">https://letsresource.in/</a>
          </li>
          <li className="mb-2">
